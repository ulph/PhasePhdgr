...
function(mod_smtg_add_vst3plugin target sdkroot)
    ...
    if(APPLE)
        ...
        if(XCODE)
            ...
            set_target_properties(${target} PROPERTIES BUNDLE_EXTENSION "vst")
        endif()
#        mod_smtg_set_exported_symbols(${target} "${sdkroot}/public.sdk/source/main/macexport.exp") #TODO, support for VST2
    elseif(WIN)
